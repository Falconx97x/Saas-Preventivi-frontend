  ...
  useEffect(() => {
    const fetchClients = async () => {
      try {
        ...
        if(!token) throw new Error("Utente non autenticato, effettuare login");
